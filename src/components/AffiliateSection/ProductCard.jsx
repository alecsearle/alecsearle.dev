...
export default function ProductCard({ product }) {
  return (
    <a
      ...
      className="flex items-center justify-between px-4 py-3.5 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 rounded-xl transition-all duration-200 group"
    >
      <div>
